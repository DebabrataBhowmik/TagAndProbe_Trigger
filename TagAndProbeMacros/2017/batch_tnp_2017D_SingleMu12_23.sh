...
g++ Run_TnP.cxx -o tnp_Mu122017F -std=c++0x `root-config --libs --cflags` -include TagAndProbe_Mu12_23_Public_2018D.C
./tnp_Mu122017F list_Mu2017F_forpublic.txt   efficiency
