...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<bool>    *passFilterMu12_L1TOnly;
   ...
   TBranch        *b_passFilterMu12_L1TOnly;   //!
...
void TagAndProbe::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("passFilterMu12_L1TOnly", &passFilterMu12_L1TOnly, &b_passFilterMu12_L1TOnly);
