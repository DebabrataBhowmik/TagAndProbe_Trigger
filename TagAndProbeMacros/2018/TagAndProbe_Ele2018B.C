...
for(int i=0; i<systematicVar.size();i++)
{
   ...
   output = "";
   output +="efficiency_";
   output +="2018B_EGM_tightid_";
   //output +="2018_EGM_looseid_";
...
//   std::cout<< "total events : "<<nentries<<endl;
   ...
   double pt_bins_Ele35[15] = {0,30,35,36,37,38,40,42,45,50,65,70,80,100,200};
...
// HLT Ele32
   ...
   TH1F *h_Ele32_eta_total = new TH1F("Ele32_eta_total","Ele32_eta",10,eta_bins);
   TH2F *h_Ele32_pt_eta_total = new TH2F("Ele32_pt_eta_total","Ele32_pt_eta",10,eta_bins,14,pt_bins_Ele32);
   TH1F *h_Ele32_pt_pass = new TH1F("Ele32_pt_pass","Ele32_pt",14,pt_bins_Ele32);
   TH1F *h_Ele32_eta_pass = new TH1F("Ele32_eta_pass","Ele32_eta",10,eta_bins);
   TH2F *h_Ele32_pt_eta_pass = new TH2F("Ele32_pt_eta_pass","Ele32_pt_eta",10,eta_bins,14,pt_bins_Ele32);
...
// HLT Ele35
   TH1F *h_Ele35_pt_total = new TH1F("Ele35_pt_total","Ele35_pt",14,pt_bins_Ele35);
   TH1F *h_Ele35_eta_total = new TH1F("Ele35_eta_total","Ele35_eta",10,eta_bins);
   TH2F *h_Ele35_pt_eta_total = new TH2F("Ele35_pt_eta_total","Ele35_pt_eta",10,eta_bins,14,pt_bins_Ele35);
   TH1F *h_Ele35_pt_pass = new TH1F("Ele35_pt_pass","Ele35_pt",14,pt_bins_Ele35);
   TH1F *h_Ele35_eta_pass = new TH1F("Ele35_eta_pass","Ele35_eta",10,eta_bins);
   TH2F *h_Ele35_pt_eta_pass = new TH2F("Ele35_pt_eta_pass","Ele35_pt_eta",10,eta_bins,14,pt_bins_Ele35);
...
// HLT Ele23_Ele12 Ele23 leg
   ...
   TH2F *h_Ele23_Ele12_leg1_pt_eta_total = new TH2F("Ele23_Ele12_leg1_pt_eta_total","Ele23_Ele12_leg1_pt_eta",10,eta_bins,13,pt_bins_Ele23_Ele12_leg1);
   ...
   TH2F *h_Ele23_Ele12_leg1_pt_eta_pass = new TH2F("Ele23_Ele12_leg1_pt_eta_pass","Ele23_Ele12_leg1_pt_eta",10,eta_bins,13,pt_bins_Ele23_Ele12_leg1);
...
// HLT Ele23_Ele12 Ele12 leg
   ...
   TH2F *h_Ele23_Ele12_leg2_pt_eta_total = new TH2F("Ele23_Ele12_leg2_pt_eta_total","Ele23_Ele12_leg2_pt_eta",10,eta_bins,15,pt_bins_Ele23_Ele12_leg2);
   ...
   TH2F *h_Ele23_Ele12_leg2_pt_eta_pass = new TH2F("Ele23_Ele12_leg2_pt_eta_pass","Ele23_Ele12_leg2_pt_eta",10,eta_bins,15,pt_bins_Ele23_Ele12_leg2);
...
//if (!passEleIdTight) return false;
if (!passEleIdMedium) return false;
