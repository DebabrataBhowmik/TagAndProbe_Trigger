...
//   output +="2018A_SingleMu12_23_";
   output +="tests_SingleMu12_23_NoL1Quality";   
//   output += systematicVar.at(i);
   ...
   double pt_bins_IsoMu24[17] = {0,10,20,24,25,26,27,28,29,30,35,40,45,50,60,100,200};
   double pt_bins_IsoMu27[17] = {0,10,20,23,25,26,27,28,29,30,35,40,45,50,60,100,200};
   double pt_bins_Mu50[13] = {0,45,50,51,52,54,56,60,65,75,100,150,200};
...
// HLT Mu50
   ...
   TH1F *h_Mu50_pt_total = new TH1F("Mu50_pt_total","Mu50_pt",12,pt_bins_Mu50);
   TH1F *h_Mu50_eta_total = new TH1F("Mu50_eta_total","Mu50_eta",13,eta_bins);
   TH2F *h_Mu50_pt_eta_total = new TH2F("Mu50_pt_eta_total","Mu50_pt_eta",13,eta_bins,12,pt_bins_Mu50);
   TH1F *h_Mu50_pt_pass = new TH1F("Mu50_pt_pass","Mu50_pt",12,pt_bins_Mu50);
   TH1F *h_Mu50_eta_pass = new TH1F("Mu50_eta_pass","Mu50_eta",13,eta_bins);
   TH2F *h_Mu50_pt_eta_pass = new TH2F("Mu50_pt_eta_pass","Mu50_pt_eta",13,eta_bins,12,pt_bins_Mu50);
...
/*
      ...
      if(mu_pt->at(second)>55)h_Mu50_eta_total->Fill(mu_eta->at(second));
...
/*
     ...
     if(mu_pt->at(second)>55) h_Mu50_eta_pass->Fill(mu_eta->at(second));
...
//cout << "h_Mu23_pt_total   = " << h_Mu23_pt_total->Integral() << endl;
//cout << "h_Mu23_pt_pass   = " << h_Mu23_pt_pass->Integral() << endl;
