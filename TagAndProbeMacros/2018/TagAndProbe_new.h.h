...
// Tue Feb 26 14:45:21 2019 by ROOT version 5.34/38
// from TTree EventTree/Event data
// found on file: /eos/cms/store/group/phys_higgs/cmshww/arun/TriggerEff_RunIILegacy/TrigEff_HWW_EGamma_2018/EGamma/Run2018A/190225_160848/0000/TnP_ntuple_84.root
//////////////////////////////////////////////////////////

#ifndef TagAndProbe_new.h_h
#define TagAndProbe_new.h_h
...
public :
   ...
   TagAndProbe_new.h(TTree *tree=0);
   virtual ~TagAndProbe_new.h();
...
#ifdef TagAndProbe_new.h_cxx
TagAndProbe_new.h::TagAndProbe_new.h(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/group/phys_higgs/cmshww/arun/TriggerEff_RunIILegacy/TrigEff_HWW_EGamma_2018/EGamma/Run2018A/190225_160848/0000/TnP_ntuple_84.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/group/phys_higgs/cmshww/arun/TriggerEff_RunIILegacy/TrigEff_HWW_EGamma_2018/EGamma/Run2018A/190225_160848/0000/TnP_ntuple_84.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/eos/cms/store/group/phys_higgs/cmshww/arun/TriggerEff_RunIILegacy/TrigEff_HWW_EGamma_2018/EGamma/Run2018A/190225_160848/0000/TnP_ntuple_84.root:/ntupler");
...
TagAndProbe_new.h::~TagAndProbe_new.h()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TagAndProbe_new.h::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TagAndProbe_new.h::LoadTree(Long64_t entry)
{
...
void TagAndProbe_new.h::Init(TTree *tree)
{
...
Bool_t TagAndProbe_new.h::Notify()
{
...
void TagAndProbe_new.h::Show(Long64_t entry)
{
...
Int_t TagAndProbe_new.h::Cut(Long64_t entry)
{
...
#endif // #ifdef TagAndProbe_new.h_cxx
